...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '9f9c7354cfbe49a1af4695cfb2d55723',
  ...
  TAG_SORT_BY_COUNT: true, // 标签是否按照文章数量倒序排列t，文章多的标签排在前。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '二虎', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '麻辣拌爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.erhul.art', // 网站地址
  ...
  CUSTOM_RIGHT_CLICK_CONTEXT_MENU_THEME_SWITCH: false, // 是否显示切换主题
